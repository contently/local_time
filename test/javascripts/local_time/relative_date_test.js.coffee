...
test "more than a day", ->
  still_somewhat_recent = moment().subtract("hours", 29).subtract("seconds", 39)
  el = addTimeEl type: "twitter", datetime: still_somewhat_recent.toISOString()
  run()
